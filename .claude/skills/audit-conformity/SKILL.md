...
description: >
  Audit an existing project against claude-code-starter-kit best practices.
  Produces a scorecard with conformity status and corrective actions.
  Triggers: "audit conformity", "check conformity", "audit project", "compliance check".
---
...
- Use `ls` and Glob to find actual source directories
