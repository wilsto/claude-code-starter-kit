...
| Skill | What it does |
|-------|-------------|
| **spec-update** | Post-change documentation: functional specs per domain in `docs/specs/`, README updates, lessons learned |
...
│   └── specs/                   # Functional specifications per domain (auto-generated by /spec-update)
├── .claude/
